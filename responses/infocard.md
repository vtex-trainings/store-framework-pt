...
A partir do código acima, no arquivo `home.jsonc`, crie o `info-card#button-left` logo abaixo deste infocard `info-card#button-left`. Este novo infocard deve possuir:
