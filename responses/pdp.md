...
Construa uma página de produto usando os blocos `product-images`, `product-price`, `product-name` e [`buy-button`](https://vtex.io/docs/app/vtex.store-components/buy-button). Esperamos que na estrutura tenhamos:  
